...
class ObjectPickSimulator(Node):
    def __init__(self):
        ...
        self.place_change_offset = 1.4
        self.place_change_duration = 0.2
    ...
    def update_gripper(self):
        ...
        if self.current_action == "PICK":
            ...
            elif time_in_action < self.place_change_offset:
                strength = 100.0
            elif time_in_action < self.place_change_offset + self.place_change_duration:
                phase = (time_in_action - self.place_change_offset) / self.place_change_duration
